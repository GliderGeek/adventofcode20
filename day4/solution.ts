function getPassports(input: string[]){
    let passports = []
...
function part1(passports): number{
    let necessaryKeys =[
        "byr",
        "iyr",
        "eyr",
    ...
    for (let i = 0; i < passports.length; i++) {
        ...
        for (let j = 0; j < necessaryKeys.length; j++) {
            const key = necessaryKeys[j];
            if (!(key in passport)){
                valid = false
                break
            }
...
function byrValidate(inp): boolean{
    let matches = inp.match(/^\d\d\d\d$/)
    if (matches != null){
...
function iyrValidate(inp): boolean{
    let matches = inp.match(/^\d\d\d\d$/)
    if (matches != null){
        const number = parseInt(matches[0])
...
function eyrValidate(inp): boolean{
    let matches = inp.match(/^\d\d\d\d$/)
    if (matches != null){
        const number = parseInt(matches[0])
...
function hgtValidate(inp): boolean{
    let matches = inp.match(/^(\d+)(in|cm)$/)
    if (matches != null){
...
function hclValidate(inp): boolean{
    let matches = inp.match(/^#[0-9a-f]{6}$/)
    return (matches != null)
}

function eclValidate(inp): boolean{
    let matches = inp.match(/^(amb|blu|brn|gry|grn|hzl|oth)$/)
    return (matches != null)
}

function pidValidate(inp): boolean{
    let matches = inp.match(/^[0-9]{9}$/)
    return (matches != null)
}

function cidValidate(inp): boolean{
    return true
}

function part2(passports): number{
    let necessaryKeys ={
        "byr": byrValidate,
        "iyr": iyrValidate,
        "eyr": eyrValidate,
    ...
    for (let i = 0; i < passports.length; i++) {
        ...
        for (const key in necessaryKeys) {
            ...
            if (!(necessaryKeys[key](passport[key]))){
                valid = false
                break
            }
        }
...
console.log("answer part 1:", part1(passports))
console.log("answer part 2:", part2(passports))
